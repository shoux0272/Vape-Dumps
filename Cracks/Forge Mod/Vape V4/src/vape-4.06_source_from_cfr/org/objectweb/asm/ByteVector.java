...
public class ByteVector {
    ...
    public ByteVector putUTF8(String stringValue) {
        ...
        for (int i10 = 0; i10 < charLength; ++i10) {
            char charValue = stringValue.charAt(i10);
            if (charValue < '\u0001' || charValue > '\u007f') {
                this.length = currentLength;
                return this.encodeUtf8(stringValue, i10, 65535);
            }
    ...
    final ByteVector encodeUtf8(String stringValue, int offset, int maxByteLength) {
        ...
        for (int i10 = offset; i10 < charLength; ++i10) {
            char charValue = stringValue.charAt(i10);
            if (charValue >= '\u0001' && charValue <= '\u007f') {
                ++byteLength;
                continue;
        ...
        int currentLength = this.length;
        for (int i11 = offset; i11 < charLength; ++i11) {
            char charValue = stringValue.charAt(i11);
            if (charValue >= '\u0001' && charValue <= '\u007f') {
