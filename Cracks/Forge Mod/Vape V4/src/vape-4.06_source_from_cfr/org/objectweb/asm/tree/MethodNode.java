...
extends MethodVisitor {
    ...
    private LabelNode[] getLabelNodes(Label[] labels) {
        ...
        int n6 = labels.length;
        for (int i10 = 0; i10 < n6; ++i10) {
            labelNodes[i10] = this.getLabelNode(labels[i10]);
        }
        return labelNodes;
    }
    ...
    public void check(int api) {
        ...
        if (api == 262144) {
            ...
            if (this.tryCatchBlocks != null) {
                for (i10 = this.tryCatchBlocks.size() - 1; i10 >= 0; --i10) {
                    TryCatchBlockNode tryCatchBlock = this.tryCatchBlocks.get(i10);
            ...
            for (i10 = this.instructions.size() - 1; i10 >= 0; --i10) {
                Object value;
                boolean isInterface;
                insn = this.instructions.get(i10);
    ...
    public void accept(MethodVisitor methodVisitor) {
        ...
        if (this.visibleAnnotations != null) {
            ...
            for (i10 = 0; i10 < n6; ++i10) {
                annotation2 = this.visibleAnnotations.get(i10);
        ...
        if (this.invisibleAnnotations != null) {
            ...
            for (i10 = 0; i10 < n6; ++i10) {
                annotation2 = this.invisibleAnnotations.get(i10);
        ...
        if (this.visibleParameterAnnotations != null) {
            n6 = this.visibleParameterAnnotations.length;
            for (i10 = 0; i10 < n6; ++i10) {
                parameterAnnotations = this.visibleParameterAnnotations[i10];
                if (parameterAnnotations == null) continue;
                m = parameterAnnotations.size();
                for (j10 = 0; j10 < m; ++j10) {
                    annotation = parameterAnnotations.get(j10);
                    annotation.accept(methodVisitor.visitParameterAnnotation(i10, annotation.desc, true));
                }
            }
        }
        ...
        if (this.invisibleParameterAnnotations != null) {
            n6 = this.invisibleParameterAnnotations.length;
            for (i10 = 0; i10 < n6; ++i10) {
                parameterAnnotations = this.invisibleParameterAnnotations[i10];
                if (parameterAnnotations == null) continue;
                m = parameterAnnotations.size();
                for (j10 = 0; j10 < m; ++j10) {
                    annotation = parameterAnnotations.get(j10);
                    annotation.accept(methodVisitor.visitParameterAnnotation(i10, annotation.desc, false));
                }
            }
        }
        if (this.visited) {
        ...
        if (this.attrs != null) {
            n6 = this.attrs.size();
            for (i10 = 0; i10 < n6; ++i10) {
                methodVisitor.visitAttribute(this.attrs.get(i10));
            }
        }
        if (this.instructions.size() > 0) {
            methodVisitor.visitCode();
            if (this.tryCatchBlocks != null) {
                n6 = this.tryCatchBlocks.size();
                for (i10 = 0; i10 < n6; ++i10) {
            ...
            if (this.localVariables != null) {
                n6 = this.localVariables.size();
                for (i10 = 0; i10 < n6; ++i10) {
                    this.localVariables.get(i10).accept(methodVisitor);
                }
            }
            if (this.visibleLocalVariableAnnotations != null) {
                n6 = this.visibleLocalVariableAnnotations.size();
                for (i10 = 0; i10 < n6; ++i10) {
                    this.visibleLocalVariableAnnotations.get(i10).accept(methodVisitor, true);
                }
            }
            if (this.invisibleLocalVariableAnnotations != null) {
                n6 = this.invisibleLocalVariableAnnotations.size();
                for (i10 = 0; i10 < n6; ++i10) {
                    this.invisibleLocalVariableAnnotations.get(i10).accept(methodVisitor, false);
                }
            }
