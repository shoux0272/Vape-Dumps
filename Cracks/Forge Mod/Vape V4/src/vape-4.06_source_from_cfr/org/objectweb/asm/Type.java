...
public final class Type {
    ...
    public static Type[] getArgumentTypes(Method method) {
        ...
        for (int i10 = classes.length - 1; i10 >= 0; --i10) {
            types[i10] = Type.getType(classes[i10]);
        }
        return types;
    }
    ...
    public String getClassName() {
        switch (this.sort) {
            ...
            case 9: {
                ...
                for (int i10 = this.getDimensions(); i10 > 0; --i10) {
    ...
    public boolean equals(Object object) {
        ...
        int j10 = otherBegin;
        while (i10 < end) {
            if (this.valueBuffer.charAt(i10) != other.valueBuffer.charAt(j10)) {
                return false;
            }
            ++i10;
            ++j10;
    ...
    public int hashCode() {
        ...
        if (this.sort >= 9) {
            int end = this.valueEnd;
            for (int i10 = this.valueBegin; i10 < end; ++i10) {
                hashCode = 17 * (hashCode + this.valueBuffer.charAt(i10));
            }
        }
        return hashCode;
    }
