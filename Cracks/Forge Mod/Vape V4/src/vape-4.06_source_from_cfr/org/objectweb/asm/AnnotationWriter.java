...
extends AnnotationVisitor {
    ...
    public void visit(String name, Object value) {
        ...
        if (value instanceof String) {
            ...
            for (int k = 0; k < n6; ++k) {
                ...
                this.annotation.put12(90, this.symbolTable.addConstantInteger((int)((booleanValue = arrbl[k]) ? 1 : 0)).index);
            }
        } else if (value instanceof short[]) {
    ...
    static int computeParameterAnnotationsSize(String attributeName, AnnotationWriter[] annotationWriters, int annotableParameterCount) {
        ...
        for (int i10 = 0; i10 < annotableParameterCount; ++i10) {
            AnnotationWriter annotationWriter = annotationWriters[i10];
    ...
    static void putParameterAnnotations(int attributeNameIndex, AnnotationWriter[] annotationWriters, int annotableParameterCount, ByteVector output) {
        ...
        for (i10 = 0; i10 < annotableParameterCount; ++i10) {
            annotationWriter = annotationWriters[i10];
