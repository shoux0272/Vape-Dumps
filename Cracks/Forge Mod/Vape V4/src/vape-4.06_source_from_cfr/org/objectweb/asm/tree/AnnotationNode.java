    ...
    public void accept(AnnotationVisitor annotationVisitor) {
        if (annotationVisitor != null) {
            if (this.values != null) {
                ...
                for (int i10 = 0; i10 < n6; i10 += 2) {
                    String name = (String)this.values.get(i10);
                    Object value = this.values.get(i10 + 1);
        ...
        if (annotationVisitor != null) {
            if (value instanceof String[]) {
                ...
                if (arrayAnnotationVisitor != null) {
                    ...
                    int n6 = arrayValue.size();
                    for (int i10 = 0; i10 < n6; ++i10) {
                        AnnotationNode.accept(arrayAnnotationVisitor, null, arrayValue.get(i10));
                    }
