...
import javassist.expr.Instanceof$ProceedForInstanceof;

public class Instanceof
extends Expr {
    protected Instanceof(int n6, CodeIterator codeIterator, CtClass ctClass, MethodInfo methodInfo) {
    ...
    public void replace(String string) throws CannotCompileException {
        ...
        try {
            ...
            javac.recordProceed(new Instanceof$ProceedForInstanceof(n10));
            javac.recordType(this.getType());
            Instanceof.checkResultValue(ctClass, string);
            Bytecode bytecode = javac.getBytecode();
            Instanceof.storeStack(arrctClass, true, n11, bytecode);
